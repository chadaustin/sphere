<?
  ...
  if( isset( $U_ACT ) ){
    switch( $U_ACT ){
      case "about":
        $FILES = file("/home/groups/s/sp/sphere/htdocs/images/sphere_ss/listing");
        echo "<table>";
          echo"<tr>";
            echo "<td>";
              $IMAGES = "";
              for( $x = 0; $x < count($FILES)/2; $x ++ ){
                $IMAGES = "$IMAGES<a href=\"$__SITEROOT/images/sphere_ss/".$FILES[$x].".png\"><img src=\"$__SITEROOT/images/sphere_ss/t_".$FILES[$x].".png\" alt=\"".$FILES[$x]."\" /></a>";
                $IMAGES = "$IMAGES<br />";
              }
              gen_item( "screenshots", $IMAGES );
            echo "</td>";
            echo "<td>";
            ...
            echo "<td>";
              $IMAGES = "";
              for( $x = count($FILES)/2; $x < count($FILES); $x ++ ){
                $IMAGES = "$IMAGES<a href=\"$__SITEROOT/images/sphere_ss/".$FILES[$x].".png\"><img src=\"$__SITEROOT/images/sphere_ss/t_".$FILES[$x].".png\" alt=\"".$FILES[$x]."\" /></a>";
                $IMAGES = "$IMAGES<br />";
              }
              gen_item( "screenshots", $IMAGES );
