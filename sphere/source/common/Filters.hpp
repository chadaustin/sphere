...
extern void NegativeImage(int width, int height,
                          bool red, bool green, bool blue, bool alpha, RGBA* pixels);
...
extern void
AdjustBrightness(int width, int height, RGBA* pixels,
                 int dred, int dgreen, int dblue, int dalpha = 0);

extern void
AdjustGamma(int width, int height, RGBA* pixels,
            double dred, double dgreen, double dblue, double dalpha = 1);

extern unsigned long
CountColorsUsed(const RGBA* pixels, const int width, const int height,
