...
template<typename T>
void SuperEagle(T* dst, T* src, int src_width, int src_height)
{
...
template<typename T>
void Super2xSaI(T* dst, T* src, int src_width, int src_height)
{
...
template<typename T>
void _2xSaI(T* dst, T* src, int src_width, int src_height)
{
