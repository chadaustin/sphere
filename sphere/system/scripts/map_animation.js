...
// If you want to clear the array, simply call the ClearArray function and begin again
...
// just call the ClearArray() function. Give the engine a FlipScreen or preferably an Engine
...
function UpdateMapAnimation() {
  for (var i = 0; i < g_map_animations.length; ++i) { // loop through the animations in the array
